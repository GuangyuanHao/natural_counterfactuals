...
#hvae # bash run_local_box222_h.sh box2_hvae_prh nohup gpu=7 --epochs 200 --bs=128
#hvae # bash run_local_box222_h.sh box22_hvae_prh nohup gpu=3 --epochs 1000 --bs=64